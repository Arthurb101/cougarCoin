...
Ensure your gitian.sigs.CGC are up-to-date if you wish to gverify your builds against other Gitian signatures.

    pushd ./gitian.sigs.CGC
    git pull
    popd
...
### Build and sign Cougarcoin Core for Linux, Windows, and OS X:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs.CGC/ ../cougarcoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs.CGC/ ../cougarcoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.CGC/ ../cougarcoin/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  5. Gitian signatures (in `gitian.sigs.CGC/${VERSION}-<linux|{win,osx}-unsigned>/(your Gitian key)/`)
...
Commit your signature to gitian.sigs.CGC:
    ...
    git commit -a
    git push  # Assuming you can push to the gitian.sigs.CGC tree
    popd
...
Create (and optionally verify) the signed OS X binary:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs.CGC/ ../cougarcoin/contrib/gitian-descriptors/gitian-osx-signer.yml
...
Create (and optionally verify) the signed Windows binaries:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.CGC/ ../cougarcoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.CGC/ -r ${VERSION}-win-signed ../cougarcoin/contrib/gitian-descriptors/gitian-win-signer.yml
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the cougarcoin.org server.

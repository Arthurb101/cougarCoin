...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cougarcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cougarcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cougarcoin transaction") + "\n" +
              "  cougarcoin-tx [options] -create [commands]   " + _("Create hex-encoded cougarcoin transaction") + "\n" +
              "\n";

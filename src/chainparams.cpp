...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.cougarcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.cougarcointools.com", true);
        vSeeds.emplace_back("dnsseed.cougarcoinpool.org", true);
        ...
        fDefauCGConsistencyChecks = false;
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.cougarcointools.com", true);
        vSeeds.emplace_back("seed-b.cougarcoin.loshan.co.uk", true);
...
public:
    CRegTestParams() {
        ...
        fDefauCGConsistencyChecks = true;
        fRequireStandard = false;
